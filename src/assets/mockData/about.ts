...
export const initExpData = [
  {
    id: "first-p-about",
    content:
      "2021 - 2022: Développeur React Native Fullstack. AWS cloud services, Node JS, PHP",
  },
  {
    id: "second-p-about",
  ...
  },
  {
    id: "forth-p-about",
    content:
      "Jan. 2017 - Aug. 2018 : Developer at Codebusters. Mainly in HTML5 & CSS3, React JS 1fit.app project",
  },
  {
    id: "fifth-p-about",
    content:
...
export const addSkillData = [
  { id: "AWS_skill", content: "AWS", porcentage: "60%", value: 60 },
  {
    id: "Apollo_GraphQL_skill",
